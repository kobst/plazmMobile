...
public final class AddUserMutation: GraphQLMutation {
  ...
  public let operationDefinition: String =
    ...
    mutation AddUser($name: String, $email: String, $phoneNumber: String, $userSub: String) {
      addUser(
        input: {name: $name, email: $email, phoneNumber: $phoneNumber, userSub: $userSub}
      ) {
        __typename
        message
        success
  ...
  public init(name: String? = nil, email: String? = nil, phoneNumber: String? = nil, userSub: String? = nil) {
    self.name = name
    self.email = email
  ...
  public var variables: GraphQLMap? {
    return ["name": name, "email": email, "phoneNumber": phoneNumber, "userSub": userSub]
  }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("addUser", arguments: ["input": ["name": GraphQLVariable("name"), "email": GraphQLVariable("email"), "phoneNumber": GraphQLVariable("phoneNumber"), "userSub": GraphQLVariable("userSub")]], type: .nonNull(.object(AddUser.selections))),
      ]
    }
    ...
    public struct AddUser: GraphQLSelectionSet {
      ...
      public struct User: GraphQLSelectionSet {
        ...
        public init(name: String? = nil, email: String? = nil, phoneNumber: String? = nil, userSub: String? = nil) {
          self.init(unsafeResultMap: ["__typename": "userProfileRef", "name": name, "email": email, "phoneNumber": phoneNumber, "userSub": userSub])
        }
